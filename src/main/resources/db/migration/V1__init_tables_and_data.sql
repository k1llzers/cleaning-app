...
CREATE TABLE IF NOT EXISTS `commercial_proposal`
(
    `id`                bigint                       NOT NULL AUTO_INCREMENT,
...
(
    ...
    CONSTRAINT `FKm5koajka35938tnksntkrm9mf` FOREIGN KEY (`review`) REFERENCES `review` (`id`),
    CONSTRAINT `FKqqw5cd6q594ac1ifjxbq1cian` FOREIGN KEY (`address`) REFERENCES `address` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci;
...
(
    ...
    CONSTRAINT `FKs9vfdbexrmy2c2l4kdyw33mcm` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci;
...
(
    ...
    CONSTRAINT `FKj2n80auouo3faxnku0h3nk0vb` FOREIGN KEY (`commercial_proposal_id`) REFERENCES `commercial_proposal` (`id`),
